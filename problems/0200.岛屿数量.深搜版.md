...
class Solution:
    def __init__(self):
        self.dirs = [[0, 1], [1, 0], [-1, 0], [0, -1]]  # Four directions

    def dfs(self, grid, visited, x, y):
        # Termination condition: visited node or water
        ...
        for i in range(4):
            nextx = x + self.dirs[i][0]
            nexty = y + self.dirs[i][1]
    ...
    def numIslands(self, grid):
        ...
        for i in range(n):
            for j in range(m):
                # If land and not visited, increment result and mark linked land as visited
